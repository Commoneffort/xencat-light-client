/**
 * Create XENCAT Token Metadata via Program Instruction
 *
 * Uses the new create_metadata instruction in xencat-mint-x1 program
 */
...
async function main() {
    ...
    console.log('XENCAT Mint:', XENCAT_MINT.toBase58());
    ...
    try {
        ...
        console.log('  • Token symbol: XENCAT');
        console.log('  • Token logo from GitHub');
